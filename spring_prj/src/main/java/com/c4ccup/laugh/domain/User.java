...
public class User {
    ...
    private List<Comedian> comedianList;
     ...
     * @return comedianList
     */
    public List<Comedian> getComedianList() {
        return comedianList;
    }
     ...
     */
    public void setComedianList(List<Comedian> comedianList) {
        this.comedianList = comedianList;
    }
